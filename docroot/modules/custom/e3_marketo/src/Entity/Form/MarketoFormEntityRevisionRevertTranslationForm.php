...
/**
 * Provides a form for reverting a Marketo form entity revision for a single translation.
 *
 * @ingroup e3_marketo
 */
class MarketoFormEntityRevisionRevertTranslationForm extends MarketoFormEntityRevisionRevertForm {
   ...
   * {@inheritdoc}
   */
  public function buildForm(array $form, FormStateInterface $form_state, $marketo_form_revision = NULL, $langcode = NULL) {
  ...
  protected function prepareRevertedRevision(MarketoFormEntityInterface $revision, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\e3_marketo\Entity\MarketoFormEntityInterface $default_revision */
