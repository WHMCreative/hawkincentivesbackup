 ...
 */
class CardRevisionDeleteForm extends ConfirmFormBase {
  ...
  /**
   * Constructs a new CardRevisionDeleteForm.
   *
  ...
  public static function create(ContainerInterface $container) {
    ...
    return new static(
      $entity_manager->getStorage('card'),
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    $this->CardStorage->deleteRevision($this->revision->getRevisionId());
    ...
    drupal_set_message(t('Revision from %revision-date of Card %title has been deleted.', ['%revision-date' => format_date($this->revision->getRevisionCreationTime()), '%title' => $this->revision->label()]));
